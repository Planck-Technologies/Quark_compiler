...
class Gate:
    ...
    def is_self_inverse(self) -> bool:
        ...
        return self._gate_type in {GateType.H, GateType.X, GateType.Y, GateType.Z, GateType.CNOT}
    ...
    def commutes_with(self, other: 'Gate') -> bool:
        ...
        def commutes_asymmetric(g1: 'Gate', g2: 'Gate') -> bool:
            if g2._gate_type == GateType.CNOT:
                ...
                if g1._gate_type == GateType.X and g1.target_qubits[0] in g2.target_qubits:
                    return True
                # Rule 4: Z-basis gates commute with the CONTROL line of a CNOT gate
                if g1._gate_type in z_basis and g1.target_qubits[0] in g2.control_qubits:
                    return True
            return False
    ...
    def __repr__(self) -> str:
        controls: str = f" ctrl={list(self.control_qubits)}" if self.control_qubits else ""
